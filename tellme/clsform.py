...
from tellme.models import Jituan,Cid,Site,Fastline,Flanline,Localline,NNIline,Siline,Monitorline,Fasttag,Flantag,Localtag,NNItag,Sitag,Monitortag,Traceentry
...
IDS=range(1,100)
for id in IDS:
    FASTID.append(('_fast'+str(id),'_fast'+str(id)))
    FLANID.append(('_flan'+str(id),'_flan'+str(id)))
    LOCALID.append(('_local'+str(id),'_local'+str(id)))
    NNIID.append(('_nni'+str(id),'_nni'+str(id)))
    SIID.append(('_si'+str(id),'_si'+str(id)))
    MONITORID.append(('_monitor'+str(id),'_monitor'+str(id)))

FASTPE=[]
FASTPES=['-','dga-fastip1','dga-fastip2','dgb-fastip1','dgb-fastip2','dgb-fastip3','dgb-flr1','dgb-flr2','dgb-bpflr1','szb-fastip1','szb-sfastip1','szb-flr1','szb-flr2','hkh-fastip1','hkh-flr1','hkh-flr2','hkh-us1','sza-flr3','sha-fastip1','sha-flr1','sha-flr2','sha-flr3','sha-flr4']
for pe in FASTPES:
    FASTPE.append((pe,pe))
